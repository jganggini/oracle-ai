...
def get_menu(modules, user):
    ...
    with st.sidebar:
        ...
        # Always shown links
        st.page_link("app.py", label="Extraction", icon=":material/upload_file:")
        st.page_link("pages/app_agents.py", label="Agent Tuning", icon=":material/tune:")

        # AI Demos Section
        ai_demos = [
            ("Select AI", "pages/app_chat_01.py", ":material/smart_toy:"),
            ("Select AI RAG", "pages/app_chat_02.py", ":material/plagiarism:"),
            ("AI Vector Search", "pages/app_chat_03.py", ":material/network_intelligence:")
        ]
        ...
        if "Administrator" in module_list:
            ...
            st.page_link("pages/app_modules.py", label="Modules", icon=":material/view_module:")
