...
def main():
    ...
    exec('developer', 'b.TABLE_USERS.sql',
        '[OK][B] CREATE TABLE USERS..................................[ CREATE_TABLE ]')

    exec('developer', 'c.TABLE_MODULES.sql',
        '[OK][C] CREATE TABLE MODULES................................[ CREATE_TABLE ]')

    exec('developer', 'd.TABLE_MODELS.sql',
        '[OK][D] CREATE TABLE MODELS.................................[ CREATE_TABLE ]')
    
    exec('developer', 'e.TABLE_AGENTS.sql',
        '[OK][E] CREATE TABLE AGENTS.................................[ CREATE_TABLE ]')

    exec('developer', 'f.TABLE_FILES.sql',
        '[OK][F] CREATE TABLE FILES..................................[ CREATE_TABLE ]')

    exec('developer', 'g.TABLE_DOCS.sql',
        '[OK][G] CREATE TABLE DOCS...................................[ CREATE_TABLE ]')

    exec('developer', 'h.SP_SEL_AI_TBL_CSV.sql',
        '[OK][H] CREATE PROCEDURE FOR SELECT AI [CSV]............[ CREATE_PROCEDURE ]')

    exec('developer', 'i.SP_SEL_AI_PROFILE.sql',
        '[OK][I] CREATE PROCEDURE FOR SELECT AI [PROFILE]......... CREATE_PROCEDURE ]')

    exec('developer', 'j.SP_SEL_AI_RAG_PROFILE.sql',
        '[OK][J] CREATE PROCEDURE FOR SELECT AI RAG [PROFILE]....[ CREATE_PROCEDURE ]')

    exec('developer', 'k.VW_DOCS_FILES.sql',
        '[OK][K] CREATE VIEW DOCS FOR VECTOS STORE....................[ CREATE_VIEW ]')

    exec('developer', 'l.SP_VECTOR_STORE.sql',
        '[OK][L] CREATE PROCEDURE VECTOS STORRE.......................[ CREATE_VIEW ]')
